                ...
                {portalImage&&(
                    <Portal handleClosePortal={()=>{setPortalImage(null)}}>
                        <div className="portal-content">
                            <img className="img-display" src={`mid_res/${portalImage}.jpeg`}
                ...
                <div className="section-container">
                    ...
                    <div className="planner-container">
                        ...
                        <div className="planner-info">
                            ...
                            <p>Step into a realm of fantasy and organization with our <strong>Medieval Dragon Month Planner</strong>! This high-resolution 
                            PNG asset combines the fierce elegance of dragons with intricate medieval designs to create a planner that's not only functional but also a work of art. Whether you&apos;re jotting down quests, planning battles, or just scheduling your weekly grocery run, this planner is your ultimate companion.</p>
                            <ul>
                ...
                <div className="section-container">
                    ...
                    <div className="sticker-container">
                        {stickers.map((sticker,stickerIndex)=>{
                            ...
                            const stickerImgUrl = sticker.name.replaceAll(' Badge','').replaceAll(' ','_')

                            return (
                                <div key={stickerIndex} className="sticker-card">
                                    <button onClick={()=>{ setPortalImage(stickerImgUrl)} } className="img-button">
                                        <img src={`low_res/${stickerImgUrl}.jpeg`} alt={`${stickerName}-low-res`}></img>
                                    </button>

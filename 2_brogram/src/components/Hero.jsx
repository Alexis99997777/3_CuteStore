export default function Hero(){
    return (
        <>
            ...
            <h3>The Rules</h3>
            <p>To complete this program, you <b>MUST</b> follow thses 3 simple rules:</p>
            <ul className="rules-list">
                ...
                <div className="rule-item">
                    <p><b>Reps</b></p>
                    <p>Every rep is a pause rep following a <abbr title="2 seconds down - 2 seconds pause - 2 seconds up"
                    >2 - 2 - 2 tempo</abbr></p>
                </div>

                <div className="rule-item">
                    <p><b>Weight*</b></p>
                    <p>Select the maximum weight that allows you to complete the set with good</p>
                </div>
            

            </ul>
            <small>*The first and the second set should be at 75% and 85% of your working weight used for the last two sets.</small>

...
export default function WorkoutCard(props){
    ...
    // const showExerciseDescription = { name:"as-da", description:"asda" }
        ...
        <div className="workout-container">
            ...
            <div className="workout-grid">
                <div className="exercise-name">
                    <h4 className="weight-input">Warmup</h4>
                </div>
                <h6>Sets</h6>
                <h6>Reps</h6>
                <h6>Max Weight</h6>
            ...
            <div className="workout-grid">
                <div className="exercise-name">
                    <h4 className="weight-input">Workout</h4>
                </div>
                <h6>Sets</h6>
                <h6>Reps</h6>
                <h6>Max Weight</h6>
                {workout.map((workoutExercise,wIndex)=>{
                    return (
                        <React.Fragment key={wIndex}>
                            ...
                            }}className="weight-input" placeholder='14'></input>
                        </React.Fragment>
                    )
                })}
            </div>

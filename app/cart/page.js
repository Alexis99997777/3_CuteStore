...
export default function CartPage() {
    ...
    async function createCheckout(){
      try {
          ...
          console.log('Error creatinng checkout', err.message)
      }
        ...
        <div className="cart-container">
          {Object.keys(cart).map((item,itemIndex) => {
              ...
              const imgName = itemData.name === 'Medieval Dragon Month Planner'?
                'planner' :
                itemData.name.replaceAll(' Badge','').replaceAll(' ','_')
              const imgUrl = 'low_res/' + imgName + '.jpeg'


            return (
                <div key={itemIndex} className="cart-item">
                  <img src={imgUrl} alt={imgName + '-img'}></img>
                  <div className="cart-item-info">
                    <h3>{itemData.name}</h3>
                    <p>{itemData.description.slice(0,100)}{itemData.
                    ...
                    <div className="quantity-container">
                      ...
                      onChange={(e)=> {
                        ...
                        handleIncrementProduct(itemData.
                        default_price,newValue, itemData,true)
